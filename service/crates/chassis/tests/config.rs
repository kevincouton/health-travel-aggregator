...
fn defaults_are_fail_closed() {
    ...
    // "health-travel-aggregator" until bin/instantiate-platform substitutes it,
    // matching the Go template's behavior.
    assert_eq!(PLATFORM_NAME, "health-travel-aggregator");
    assert_eq!(cfg.platform_name, "health-travel-aggregator");
    assert_eq!(cfg.database_path, "./data/health-travel-aggregator.db");
